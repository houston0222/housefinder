...
The pipeline is orchestrated by `run_pipeline.py`, which executes each processing stage in sequence while keeping the individual stages independently runnable and testable.
